...
The control conditions are cells and tissues' environments (e.g. treatment, growth and extraction protocol). The test conditions are different cells (regulatory T cells and conventional CD4 T cells) and different tissues (tumor, normal breast parenchyma, peripheral blood).
